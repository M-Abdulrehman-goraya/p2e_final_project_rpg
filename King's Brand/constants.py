...
font = pygame.font.Font("assets/Ldfcomicsansbold-zgma.ttf", 28) #Setting up big fonts
small_font = pygame.font.Font("assets/Ldfcomicsansbold-zgma.ttf", 18) #Setting up small fonts
